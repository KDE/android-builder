...
function cmakeandroid {
    cmake \$@ -DCMAKE_INSTALL_PREFIX=$ADIR/kde/install -DCMAKE_PREFIX_PATH="$ADIR/Qt5.5.0/5.5/android_armv7/;$ADIR/kde/install" -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE=$ADIR/kde/install/share/ECM/toolchain/Android.cmake
}
EOF
